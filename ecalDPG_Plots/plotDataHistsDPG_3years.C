...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void plotDataHistsDPG_3years(std::string histOptionsFile) {
	...
	sample _data1(histOpts.get("data1"),histOpts.get("data1Legend"), histOpts.getInt("data1Marker"), histOpts.get("data1Color"));
        sample _data2(histOpts.get("data2"),histOpts.get("data2Legend"), histOpts.getInt("data2Marker"), histOpts.get("data2Color"));

	np = histOpts.getFloat("np"); 
	sc = histOpts.getFloat("sc");
	integralScale = histOpts.getFloat("integralScale");

	std::vector<sample*> data = {&_data0, &_data1, &_data2};
	...
	TString m_infoYear = "CMS #bf{#it{Preliminary}}", m_runInfo = "#bf{Run 2 (13 TeV)}";
	if(m_year.Contains("2016")) { m_infoYear = "CMS #bf{#it{Preliminary 2016}}"; m_runInfo = "#bf{35.9 fb^{-1} (13 TeV)}"; }
        else if(m_year.Contains("2017")) { m_infoYear = "CMS #bf{#it{Preliminary 2017}}"; m_runInfo = "#bf{41.5 fb^{-1} (13 TeV)}"; }
        else if(m_year.Contains("2018")) { m_infoYear = "CMS #bf{#it{Preliminary 2018}}"; m_runInfo = "#bf{58.8 fb^{-1} (13 TeV)}"; }
